...
const oddNames = [
    "ample", "angle", 
    "bag", "bake", "barn", "beat", "bellow", "bend", "bird", "bite", "bitter", "blink", "bloom", "blunt", "blush", "body", "bone", "boost", "bottom", "bow", "brace", "breast", "bright", "brim", "brow", "buckle", "bug",
    "candle", "chin", "clock", "cobble", "cockle", "collar", "conker", "crab", "crack", "crawl", "crease", "creep", "crest", "cross", "curve", 
    "dandy", "dare", "drape", "drop", "dry",
    "easy", "egg", "ember", 
    "fang", "far", "father", "feather", "finger", "flake", "flannel", "foot", "frock", "funnel", "fur",
    "gap", "gold", "good", "grab", "grain", "grass", "gull", "gum", "gut",
    ...
    "man", "march", "meal", "meat", "minute", "mold", "monk", "motor", "muscle",
    ...
    "sack", "salad", "search", "seat", "scallop", "shackle", "shake", "sharp", "side", "silver", "skip", "slam", "snort", "socket", "spine", "splinter", "split", "spring", "sprout", "star", "starch", "steam", "stiff", "stitch", "stone", "strap", "study", "sweet",
    "tall", "table", "tail", "tea", "temper", "tank", "tart", "tender", "tent", "thread", "thrush", "thumb", "time", "tool", "top", "tough", "tower", "track", "tread", "treat", "trump", "twitch", 
    "usher", 
    "veil", "vine", 

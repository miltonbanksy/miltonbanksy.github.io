...
const oddNames = [
    "ample", "angle", 
    "bad", "bag", "bake", "barn", "beaker", "beat", "bellow", "bend", "big", "bird", "bite", "bitter", "blink", "blood", "bloom", "blunt", "blush", "body", "bone", "boost", "bomb", "bottom", "bow", "brace", "breast", "bright", "brim", "brow", "buckle", "bug", "bung", "bulb",
    "candle", "chin", "choke", "clock", "cobble", "cockle", "collar", "conker", "crab", "crack", "crawl", "crease", "creep", "crest", "cross", "curve", 
    "dance", "dandy", "dare", "drape", "drop", "dry",
    "easy", "egg", "ember", 
    "fang", "far", "father", "feather", "finger", "flake", "flannel", "foot", "fossil", "frock", "funk", "funnel", "fur",
    "gallop", "gallow", "gap", "gold", "good", "grab", "grain", "grass", "gray", "gull", "gum", "gut",
    ...
    "lady", "lamp", "large", "leather", "leg", "lemon", "lever", "lime", "lip", "lock", "lode", "lung",
    ...
    "sack", "salad", "search", "seat", "scallop", "shackle", "shake", "sharp", "side", "silver", "skip", "slam", "snort", "socket", "spine", "splinter", "split", "spring", "sprout", "star", "starch", "steam", "stiff", "stitch", "stone", "strangle", "strap", "study", "sweet",
    ...
    "usher", 
    "veil", "vine", 
    "wand", "waft", "war", "wart", "waste", "wave", "wear", "weasle", "weep", "west", "whistle", "wick", "wind", "wine", "winter", "witch", "wonder", "work", "worn", 
];
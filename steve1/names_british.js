...
const oddNames = [
    "ample", "angle", 
    "bad", "bag", "bake", "barn", "beaker", "beat", "bellow", "bend", "big", "bird", "bite", "bitter", "blank", "blink", "blood", "bloom", "blunt", "blush", "body", "bone", "boost", "bomb", "bottle", "bottom", "bow", "brace", "breast", "bright", "brim", "brow", "buckle", "bug", "bung", "bulb",
    "candle", "cheer", "chin", "choke", "clock", "cobble", "cockle", "collar", "conker", "crab", "crack", "crawl", "crease", "creep", "crest", "cross", "curve", 
    "dance", "dandy", "dare", "dark", "dash", "dew", "dog", "drape", "dread", "drift", "drop", "dry", "dust",
    "easy", "egg", "ember", 
    "fang", "far", "father", "feather", "finger", "flake", "flannel", "fleck", "foot", "fossil", "frock", "funk", "funnel", "fur",
    "gallop", "gallow", "gap", "gaze", "gold", "good", "grab", "grain", "grass", "gray", "great", "gull", "gum", "gut",
    "hair", "hall", "hand", "harm", "harp", "harsh", "hat", "haunt", "hay", "head", "health", "heap", "heart", "herb", "hit", "hint", "hold", "honey", "honor", "hound", "hurry", "hush",
    "idol", "imp", "iron", 
    "jangle", "jiggle", "jug", "juice",
    "karma", "keep", "keg", "kennel", "kettle", "key", "kick", "kid", "kidney", "kind", "king", "knuckle",
    "lady", "lamp", "large", "lash", "leather", "leg", "lemon", "lever", "lime", "lip", "lock", "lode", "loyal", "lung",
    "man", "march", "mask", "meal", "meat", "minute", "mold", "monk", "mop", "motor", "muscle", "mush",
    "nail", "nap", "near", "neat", "neck", "nest", "new", "night", "nip", "noon", "nose", "nut",
    "old", "olive", "omen", "organ",
    "paper", "parch", "patch", "pay", "peach", "pedal", "peel", "pin", "pint", "pluck", "plumb", "pocket", "pond", "pop", "pouch", "prawn", "pretty", "pringle", "pull", "punt",
    "quarrel", "quench", "quiver",
    "rail", "rain", "ram", "reach", "rib", "ridge", "ring", "rinse", "ripple", "rose", "rub", 
    "sack", "salad", "search", "season", "seat", "scallop", "shackle", "shake", "sharp", "shut", "side", "silver", "sin", "skip", "slam", "snort", "socket", "spine", "splinter", "split", "spring", "sprout", "squash", "star", "starch", "steam", "stiff", "stitch", "stone", "strangle", "strap", "study", "suffer", "sweep", "sweet",
    ...
    "usher", "utter",
    "veil", "vine", 
    "wand", "waft", "war", "wart", "waste", "wave", "wear", "weasle", "weather", "weep", "west", "whimper", "whip", "whistle", "wick", "wind", "wine", "winter", "wipe", "wise", "wish", "witch", "wolf", "wonder", "work", "worn", "wrack", "wreck",
];
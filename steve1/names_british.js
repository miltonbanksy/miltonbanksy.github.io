...
const oddNames = [
    "ample", "angle", 
    "bad", "bag", "bake", "barn", "beaker", "beat", "bellow", "bend", "big", "bird", "bite", "bitter", "blank", "blink", "blood", "bloom", "blunt", "blush", "body", "bone", "boost", "bomb", "bottom", "bow", "brace", "breast", "bright", "brim", "brow", "buckle", "bug", "bung", "bulb",
    "candle", "cheer", "chin", "choke", "clock", "cobble", "cockle", "collar", "conker", "crab", "crack", "crawl", "crease", "creep", "crest", "cross", "curve", 
    "dance", "dandy", "dare", "dark", "drape", "dread", "drift", "drop", "dry",
    "easy", "egg", "ember", 
    "fang", "far", "father", "feather", "finger", "flake", "flannel", "foot", "fossil", "frock", "funk", "funnel", "fur",
    "gallop", "gallow", "gap", "gaze", "gold", "good", "grab", "grain", "grass", "gray", "gull", "gum", "gut",
    "hair", "hall", "hand", "harm", "harp", "hat", "haunt", "hay", "head", "health", "heap", "heart", "hit", "hint", "hold", "honey", "honor", "hush",
    "idol", "imp", "iron", 
    "jangle", "jiggle", "jug", "juice",
    "karma", "keep", "keg", "kennel", "kettle", "key", "kick", "kid", "kidney", "kind", "king", "knuckle",
    "lady", "lamp", "large", "leather", "leg", "lemon", "lever", "lime", "lip", "lock", "lode", "loyal", "lung",
    "man", "march", "mask", "meal", "meat", "minute", "mold", "monk", "motor", "muscle", "mush",
    "nail", "nap", "near", "neat", "neck", "nest", "new", "night", "nip", "noon", "nose", "nut",
    "old", "olive", "omen", "organ",
    "paper", "parch", "patch", "pay", "peach", "pedal", "peel", "pin", "pint", "pluck", "plumb", "pocket", "pond", "pop", "pouch", "prawn", "pretty", "pringle",
    "quarrel", "quench", "quiver",
    "rain", "ram", "reach", "rib", "ridge", "ring", "rinse", "ripple", "rose", "rub", 
    "sack", "salad", "search", "seat", "scallop", "shackle", "shake", "sharp", "side", "silver", "sin", "skip", "slam", "snort", "socket", "spine", "splinter", "split", "spring", "sprout", "squash", "star", "starch", "steam", "stiff", "stitch", "stone", "strangle", "strap", "study", "suffer", "sweet",
    "tall", "table", "tail", "tea", "temper", "tank", "tart", "tender", "tent", "thread", "throb", "thrush", "thumb", "time", "tool", "top", "tough", "tower", "track", "tread", "treat", "trump", "twitch", 
    "usher", "utter",
    "veil", "vine", 
    "wand", "waft", "war", "wart", "waste", "wave", "wear", "weasle", "weep", "west", "whip", "whistle", "wick", "wind", "wine", "winter", "witch", "wonder", "work", "worn", "wreck",
];